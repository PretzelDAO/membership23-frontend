...
const variantStyles = {
  solid: {
    ...
    teal: 'bg-teal-600 text-white hover:bg-teal-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600 active:bg-teal-700 active:text-white/80 disabled:opacity-30 disabled:hover:bg-teal-600',
    white:
  ...
  outline: {
    ...
    teal: 'border-teal-300 text-teal-600 hover:border-teal-400 hover:bg-teal-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600 active:text-teal-600/70 disabled:opacity-40 disabled:hover:border-teal-300 disabled:hover:bg-transparent',
  },
}
